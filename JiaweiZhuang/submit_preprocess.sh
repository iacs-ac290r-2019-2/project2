...
#SBATCH --job-name preprocess_re10pe10
...
#python -u ./preprocess_vtk.py --case re5pe10 --thin 5  2>&1 > preprocess_re5pe10.log

#python -u ./preprocess_vtk.py --case re10pe1 --thin 5  2>&1 > preprocess_re10pe1.log
python -u ./preprocess_vtk.py --case re10pe10 --thin 5  2>&1 > preprocess_re10pe10.log
